 ...
 * ```
 */
declare const StylesProvider: react.Provider<Dict<SystemStyleObject>>;
declare const useStyles: () => Dict<SystemStyleObject>;
...
declare type CreateStyleContextReturn = CreateContextReturn<Dict<SystemStyleObject>>;
/**
