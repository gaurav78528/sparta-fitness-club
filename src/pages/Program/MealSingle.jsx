...
export default function MealSingle() {
  ...
  useEffect(() => {
    getData(`https://fitness-handler.vercel.app/Meal/${id}`).then(
      (res) => setState(res)
      //console.log(res)
    );
  }, [id]);
        ...
        <Stack spacing={{ base: 6, md: 10 }}>
          ...
          >
            ...
            <Text
              ...
              mb={"4"}
            >
              Our goal is to teach you how to craft meals in a healthy,
              enjoyable, and optimal way.
            </Text>
            <VStack spacing={{ base: 4, sm: 6 }}>
              <Text fontSize={"lg"}>{state.goal}</Text>
            </VStack>
            ...
            <VStack spacing={{ base: 4, sm: 6 }}>
              <Text fontSize={"lg"}>{state.learning}</Text>
            </VStack>
            <Box>
              <Text
                fontSize={{ base: "16px", lg: "18px" }}
