...
import { Grid, GridItem, Heading , Box, Flex, Button, Collapse, useDisclosure, InputGroup, Input, InputRightElement, Accordion, AccordionItem, AccordionButton, AccordionPanel, Text, IconButton, Hide} from '@chakra-ui/react'
import axios from 'axios'
import { BiSearchAlt2 } from 'react-icons/bi'
import { AddIcon, MinusIcon, SearchIcon, TriangleDownIcon } from '@chakra-ui/icons'
  ...
  return (
    ...
    {({ isExpanded }) => (
      <>
        ...
        <AccordionPanel pb={4}>
          <Flex>
               <Input w={{ base: '100px', md: '300px', lg: '400px' }} placeholder='Search Item'/>
